...
namespace WinFormsAppGEV
{
    public partial class FormGEV : Form
    {
        ...
        public FormGEV()
        {
            ...
            Database.InitializeClients();
            Database.InitializeSuppliers();
            Database.InitializeProducts();
            Database.InitializeSales();
            Database.InitializeOrders();
        }
        ...
        {
            List<Sale> sales = Database.SalesList;
            richTextBox1.BringToFront();
            richTextBox1.Text = "";
        ...
        {
            List<Order> orders = Database.OrdersList;
            richTextBox1.BringToFront();
            richTextBox1.Text = "";
