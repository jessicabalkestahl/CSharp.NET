...
namespace WinFormsAppGEV
{
    ...
    {
        List<Order> OrdersList = Database.OrdersList;
        List<Product> products = Database.ProductsList;
        List<Supplier> suppliers = Database.SuppliersList;
        ...
        private Supplier GetSupplier()
        {
            ...
            {
                if (supplier.Designation == (string)comboBox2.Items[comboBox2.SelectedIndex])
                {
                    return supplier;
                }
            }
        ...
        {
            int orderID = (int)comboBox1.SelectedItem;
            FillOrderInfo(orderID);
            Debug.Write(comboBox1.SelectedItem);
        }
